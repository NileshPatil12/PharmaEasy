<?php
$connection = mysqli_connect("localhost", "root", "", "pharmaeasy");
...
function add_cart($item_id)
{
    ...
    if (!isset($_GET['quantity'])) {
        // handle the case when the 'quantity' parameter is not set in the URL
        // maybe show an error message and redirect the user back to the product page
        return;
    }
